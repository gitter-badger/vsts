...
export class V1Api {
     ...
     */
    public applicationsGet (applicationKey: string, includeModules?: boolean, includeEnvStatus?: boolean) : Promise<{ response: http.IncomingMessage; body: Application;  }> {
     ...
     * @param includeEnvStatus When set to true, the application status per environment is also returned. The default value is false.
     */
    public applicationsList (includeModules?: boolean, includeEnvStatus?: boolean) : Promise<{ response: http.IncomingMessage; body: Array<Application>;  }> {
     ...
     * @param includeModules When set to true, the modules details are also retrieved. The default value is false.
     */
    public applicationsVersionsGet (applicationKey: string, versionKey: string, includeModules: boolean) : Promise<{ response: http.IncomingMessage; body: ApplicationVersion;  }> {
     ...
     */
    public applicationsVersionsList (applicationKey: string, maximumVersionsToReturn?: number) : Promise<{ response: http.IncomingMessage; body: Array<ApplicationVersion>;  }> {
     ...
     */
    public deploymentsCreate (deploymentData: NotesSourceEnvironmentKeyTargetEnvironmentKeyApplicationVersionKeysRecord) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public deploymentsDelete (deploymentKey: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public deploymentsExecuteCommand (deploymentKey: string, command: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public deploymentsGet (deploymentKey: string) : Promise<{ response: http.IncomingMessage; body: DeploymentApplicationConflictsRecord;  }> {
        const localVarPath = this.basePath + '/deployments/{DeploymentKey}/'
            .replace('{' + 'DeploymentKey' + '}', String(deploymentKey));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: DeploymentApplicationConflictsRecord;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public deploymentsGetStatus (deploymentKey: string) : Promise<{ response: http.IncomingMessage; body: DeploymentStatusDeploymentLogRecord;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: DeploymentStatusDeploymentLogRecord;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public deploymentsList (minDate?: Date, maxDate?: Date) : Promise<{ response: http.IncomingMessage; body: Array<Deployment>;  }> {
        const localVarPath = this.basePath + '/deployments/';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     */
    public deploymentsUpdate (deploymentKey: string, deploymentData: NotesSourceEnvironmentKeyTargetEnvironmentKeyApplicationVersionKeysRecord) : Promise<{ response: http.IncomingMessage; body: Deployment;  }> {
        const localVarPath = this.basePath + '/deployments/{DeploymentKey}/'
            .replace('{' + 'DeploymentKey' + '}', String(deploymentKey));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param downloadKey 
     */
    public downloads (downloadKey: string) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public environmentsApplicationsVersionsCreate (environmentKey: string, applicationKey: string, applicationVersionCreate: ApplicationVersionCreate) : Promise<{ response: http.IncomingMessage; body: ApplicationVersionKeyRecord;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: ApplicationVersionKeyRecord;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public environmentsDownloadRunningApp (environmentKey: string, applicationKey: string, type?: string) : Promise<{ response: http.IncomingMessage; body: DownloadLink;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: DownloadLink;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public environmentsGet (environmentKey: string) : Promise<{ response: http.IncomingMessage; body: Environment;  }> {
     ...
     * @param includeModules When set to true, the modules details are also retrieved. The default value is false.
     */
    public environmentsGetRunningApp (environmentKey: string, applicationKey: string, includeEnvStatus?: boolean, includeModules?: boolean) : Promise<{ response: http.IncomingMessage; body: Application;  }> {
     ...
     * @param includeEnvStatus When set to true, the applications’ status information in the environment is included in the result. The default value is false.
     */
    public environmentsGetRunningApps (environmentKey: string, includeModules?: boolean, includeEnvStatus?: boolean) : Promise<{ response: http.IncomingMessage; body: Array<Application>;  }> {
     ...
     */
    public environmentsList () : Promise<{ response: http.IncomingMessage; body: Array<Environment>;  }> {
     ...
     */
    public moduleVersionGet (moduleKey: string, moduleVersionKey: string, includePublicElements?: boolean, includeConsumedElements?: boolean) : Promise<{ response: http.IncomingMessage; body: ModuleVersion;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: ModuleVersion;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public moduleVersionsList (moduleKey: string, includePublicElements?: boolean, includeConsumedElements?: boolean, maximumVersionsToReturn?: number) : Promise<{ response: http.IncomingMessage; body: Array<ModuleVersion>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<ModuleVersion>;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public modulesGet (moduleKey: string, includeEnvStatus?: boolean) : Promise<{ response: http.IncomingMessage; body: Module;  }> {
     ...
     * @param includeEnvStatus When set to true, the module status per environment is also returned. The default value is false.
     */
    public modulesList (includeEnvStatus?: boolean) : Promise<{ response: http.IncomingMessage; body: Array<Module>;  }> {
